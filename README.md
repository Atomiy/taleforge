...
| **作品管理** | 多卷多章结构，支持创建作品、规划卷、管理章节 |
| **卷规划系统** | 可编辑章节槽、跨章角色分配、AI 辅助生成卷大纲/职责/衔接/伏笔 |
| **一键生成全卷** | 基于卷规划和角色表，自动逐章生成完整内容 |
| **角色卡片系统** | 作品级角色卡片管理，含身份/性格/背景/动机，自动带入创作 |
| **大纲时间线** | 含【标签】的大纲自动渲染为纵向时间线，标记各阶段完成状态 |
| **进度追踪** | 作品页进度条实时显示已完成章节数/总章节数和百分比 |
| **AI 灵感系统** | 一键生成剧情、角色、世界观灵感，可直接应用到作品设定 |
| **收藏标记** | 收藏喜欢的故事，快速筛选查看 |
