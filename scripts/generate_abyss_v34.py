"""
v3.4 生成脚本 — 复用 v3.3 生成逻辑，仅更新生成配置
"""
import json, sys, time, requests

BASE_URL = "http://127.0.0.1:8080"
with open(r'scripts\abyss_v34_config.json', 'r', encoding='utf-8') as f:
    config = json.load(f)
...
def generate_chapter(ch, prev_id=None):
    ...
    out_path = f"scripts/abyss_v34_ch{ch['chapter_num']}.txt"
